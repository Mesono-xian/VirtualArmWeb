...
/* Define to 1 if you have the `posix_spawn_file_actions_addfchdir_np'
   function. */
/* #undef HAVE_POSIX_SPAWN_FILE_ACTIONS_ADDFCHDIR_NP */
...
/* lighttpd-version-id */
#define LIGHTTPD_VERSION_ID 0x1044b
...
#define PACKAGE_STRING "lighttpd 1.4.75"
